...
class WindowedInPlaceLongTest {

    private fun subListToStdList(sub: InPlaceLongSubList): List<Long> {
    ...
    fun `windowedInPlace with valid parameters`() {
        val list = LongList(10) { it.toLong() }
        val result = list.windowedInPlace(4, 3)
        assertEquals(3, result.size)
        assertEquals(listOf(0L, 1L, 2L, 3L), subListToStdList(result[0]))
        assertEquals(listOf(3L, 4L, 5L, 6L), subListToStdList(result[1]))
        assertEquals(listOf(6L, 7L, 8L, 9L), subListToStdList(result[2]))
    }
    ...
    fun `windowedInPlace with partial windows`() {
        ...
        assertEquals(listOf(3L, 4L, 5L, 6L), subListToStdList(result[1]))
        assertEquals(listOf(6L, 7L, 8L, 9L), subListToStdList(result[2]))
        assertEquals(listOf(9L), subListToStdList(result[3]))
    }
    ...
    fun `windowedInPlace with same size and step`() {
        ...
        assertEquals(3, result.size)
        assertEquals(listOf(0L, 1L, 2L), subListToStdList(result[0]))
        assertEquals(listOf(3L, 4L, 5L), subListToStdList(result[1]))
        assertEquals(listOf(6L, 7L, 8L), subListToStdList(result[2]))
    }
    ...
    fun `windowedInPlace with default step`() {
        ...
        assertEquals(listOf(0L, 1L, 2L), subListToStdList(result[0]))
        assertEquals(listOf(1L, 2L, 3L), subListToStdList(result[1]))
        assertEquals(listOf(2L, 3L, 4L), subListToStdList(result[2]))
        assertEquals(listOf(3L, 4L, 5L), subListToStdList(result[3]))
        assertEquals(listOf(4L, 5L, 6L), subListToStdList(result[4]))
        assertEquals(listOf(5L, 6L, 7L), subListToStdList(result[5]))
        assertEquals(listOf(6L, 7L, 8L), subListToStdList(result[6]))
        assertEquals(listOf(7L, 8L, 9L), subListToStdList(result[7]))
    }

    @Test
    fun `windowedInPlace with single element list`() {
        val list = LongList(1) { 42L.toLong() }
    ...
    fun `windowedInPlace with step larger than list size`() {
        val list = LongList(5) { it.toLong() }
        val result = list.windowedInPlace(2, 10)
        assertEquals(1, result.size)
        assertEquals(listOf(0L, 1L), subListToStdList(result[0]))
    }
    ...
    fun `forEachWindow with valid parameters`() {
        ...
        assertEquals(4, result.size)
        assertEquals(listOf(0L, 1L, 2L), result[0])
        assertEquals(listOf(2L, 3L, 4L), result[1])
    }
    ...
    fun `forEachWindow with partial windows`() {
        ...
        assertEquals(4, result.size)
        assertEquals(listOf(0L, 1L, 2L, 3L), result[0])
        assertEquals(listOf(3L, 4L, 5L, 6L), result[1])
        assertEquals(listOf(6L, 7L, 8L, 9L), result[2])
        assertEquals(listOf(9L), result[3])
    }
    ...
    fun `forEachWindow with same size and step`() {
        ...
        assertEquals(3, result.size)
        assertEquals(listOf(0L, 1L, 2L), result[0])
        assertEquals(listOf(3L, 4L, 5L), result[1])
        assertEquals(listOf(6L, 7L, 8L), result[2])
    }
    ...
    fun `forEachWindow with default step`() {
        ...
        assertEquals(8, result.size)
        assertEquals(listOf(0L, 1L, 2L), result[0])
        assertEquals(listOf(1L, 2L, 3L), result[1])
    }

    @Test
    fun `forEachWindow with single element list`() {
        val list = LongList(1) { 1L.toLong() }
        val result = mutableListOf<List<Long>>()
    ...
    fun `forEachWindow with step larger than list size`() {
        ...
        assertEquals(1, result.size)
        assertEquals(listOf(0L, 1L), result[0])
    }
    ...
    fun `forEachWindowIndexed with valid parameters`() {
        val list = LongList(10) { it.toLong() }
        val result = mutableListOf<Pair<Int, List<Long>>>()
        list.forEachWindowIndexed(3, 2) { index, window -> result.add(index to subListToStdList(window)) }
        assertEquals(4, result.size)
        assertEquals(0 to listOf(0L, 1L, 2L), result[0])
        assertEquals(1 to listOf(2L, 3L, 4L), result[1])
    }
    ...
    fun `forEachWindowIndexed with partial windows`() {
        ...
        assertEquals(4, result.size)
        assertEquals(0 to listOf(0L, 1L, 2L, 3L), result[0])
        assertEquals(1 to listOf(3L, 4L, 5L, 6L), result[1])
        assertEquals(2 to listOf(6L, 7L, 8L, 9L), result[2])
        assertEquals(3 to listOf(9L), result[3])
    }
    ...
    fun `forEachWindowIndexed with same size and step`() {
        ...
        assertEquals(3, result.size)
        assertEquals(0 to listOf(0L, 1L, 2L), result[0])
        assertEquals(1 to listOf(3L, 4L, 5L), result[1])
        assertEquals(2 to listOf(6L, 7L, 8L), result[2])
    }
    ...
    fun `forEachWindowIndexed with default step`() {
        ...
        assertEquals(8, result.size)
        assertEquals(0 to listOf(0L, 1L, 2L), result[0])
        assertEquals(1 to listOf(1L, 2L, 3L), result[1])
    }
    ...
    fun `forEachWindowIndexed with step larger than list size`() {
        ...
        assertEquals(1, result.size)
        assertEquals(0 to listOf(0L, 1L), result[0])
    }
