 ...
 *
 */
class InPlaceLongSubList @PublishedApi internal constructor(
    /**
     * The source list from which this sublist was created.
     */
     @JvmField @PublishedApi internal val sourceList: LongList,
    /**
     ...
     * @param action The function to be executed
     */
    inline fun forEachIndexed(action: (index: Int, Long) -> Unit) {
        for (i in start until end) {
